 ...
 * Created on Octobar 2, 2022, 5:00 PM
 */
...
{
    signed char l_Ret_Val =ZERO_INIT; //ZERO_INIT the process done successfully. 
    ...
    l_Ret_Val  = close(l_Dest_File_Descriptor);
    l_Ret_Val |= close(l_Src_File_Descriptor);
